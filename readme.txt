...
The plugin settings are located under the main "Settings" menu in the WordPress admin menu.
...
= How to change the look of the review =
If you look under the "Settings" menu there is a link called "Inline Reviews" which has the available options.
